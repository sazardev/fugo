...
// materialIcons resolves an fg icon name (fg.Icons.Home -> 'home') to the
// matching Flutter IconData, preserving each icon's built-in direction.
const Map<String, IconData> materialIcons = {
  "abc": Icons.abc,
